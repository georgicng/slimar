...
!function ($) {
    ...
    BootstrapTable.prototype.initTable = function () {
        ...
        $.each(
            this.options.columns, function (i, column) {
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        $.each(
            this.options.columns, function (i, column) {
                ...
                html.push(
                    sprintf(
                        '<div class="th-inner %s">', that.options.sortable && column.sortable ?
                        'sortable' : ''
                    )
                );
        ...
        this.$container.off('click', 'th').on(
        ...
        this.$container.off('click', '[name="btSelectAll"]')
            .on(
                'click', '[name="btSelectAll"]', function () {
    ...
    BootstrapTable.prototype.initSearch = function () {
        ...
        if (this.options.sidePagination !== 'server') {
            ...
            this.data = s ? $.grep(
                this.options.data, function (item, i) {
                    for (var key in item) {
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        for (i = from; i <= to; i++) {
            html.push(
                '<li class="page-number' + (i === this.options.pageNumber ? ' active disabled' : '') + '">',
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        for (var i = this.pageFrom - 1; i < this.pageTo; i++) {
            ...
            $.each(
                this.header.fields, function (j, field) {
                    var text = '',
                    value = item[field],
                    type = '',
                    cellStyle = {},
                    ...
                    if (that.options.columns[j].checkbox || that.options.columns[j].radio) {
                        ...
                        '<input' +
                            ...
                            sprintf(
                                ' disabled="%s"', !that.options.columns[j].checkboxEnabled ||
        ...
        $.each(
            this.header.events, function (i, events) {
                if (!events) {
                    return;
                }
    ...
    BootstrapTable.prototype.resetView = function (params) {
        ...
        this.$selectAll.prop(
            'checked', this.$selectItem.length > 0 &&
    ...
    $.fn.bootstrapTable = function (option, _relatedTarget) {
        ...
        this.each(
            function () {
                ...
                options = $.extend(
                    {}, BootstrapTable.DEFAULTS, $this.data(),
